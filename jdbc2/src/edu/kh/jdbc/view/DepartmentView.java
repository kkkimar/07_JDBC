...
public class DepartmentView {
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				// : Scanner를 이용한 입력시 자료형이 잘못되면 발생
				System.out.println("\n[입력 형식이 잘못되었습니다]\n");
				input = -1;
				sc.nextLine(); //잘못 입력한 값이 스캐너 버퍼에 남아있어서 버퍼 비워주기
	...
	private void insertDepartment() throws SQLException {
		...
		// 입력 받은 값을 한번에 저장할 Department 객체 생성
...
//		int result = dao.deleteDepartment(deptCode);
//	
//	
//		if(result > 0) {
//			System.out.println(deptCode + "가 없습니다");
//		}else {
//			System.out.println(deptCode+"가 삭제되었습니다");
//		}
