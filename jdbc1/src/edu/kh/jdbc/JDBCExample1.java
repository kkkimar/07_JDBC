...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		...
		//(== dbeaver에서 DB연결을 위해 주소, 계정, 비밀번호 저장한 것과 같음)
		...
		try {
			...
			/*2-1) Oracle JDBC 객체를 메모리에 로드(적재) 하기*/
			...
			//************ JDBC에서 SQL 작성 시 ;세미콜론 작성하면 안된다!!! ******************
			//-> 세미콜론 작성하게 되면 "SQL 명령어가 올바르게 종료되지 않았습니다"라는 오류 발생
